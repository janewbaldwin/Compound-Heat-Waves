...
parser.add_option('--shiftn', dest='sfn', type='float', default=0,
        help='mean shift to the daily minimum temperature data used to calculate exceedances',
        metavar='FLO')
parser.add_option('--shiftx', dest='sfx', type='float', default=0,
        help='mean shift to the daily maxmimum temperature data used to calculate exceedances',
        metavar='FLO')
...
tmax = tmax + options.sfx
tmin = tmin + options.sfn
...
###########DEFINTION-el8-bmax2-e2l1-dm9####################
# Inputs
bmax = 2 #maximum length of a break
e2length = 1 #required length of heat waves that can compound
elength = 8 #required length of first heat wave(>=e2length)
dmin = 9 #required minimum number of hot days for compound event
