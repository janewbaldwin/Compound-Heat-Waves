...
###########DEFINTION-el6-bmax3-e2l6-dm12####################
# Inputs
elength = 6 #required length of first heat wave(>=e2length)
bmax = 3 #maximum length of a break
e2length = 6 #required length of heat waves that can compound
dmin = 12 #required minimum number of hot days for compound event
